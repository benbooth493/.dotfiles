...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'nvim-colorizer.lua', 'lspkind-nvim', 'nvim-lspinstall', 'indent-blankline.nvim', 'neogit', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
