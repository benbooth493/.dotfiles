...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'lspkind-nvim', 'nvim-colorizer.lua', 'nvim-lspinstall', 'neogit', 'nvim-treesitter'}, { event = "BufRead *" }, _G.packer_plugins)]]
