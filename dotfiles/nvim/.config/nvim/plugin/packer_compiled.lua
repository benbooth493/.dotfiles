...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'lspkind-nvim', 'neogit', 'nvim-colorizer.lua', 'nvim-lspinstall', 'nvim-treesitter', 'indent-blankline.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
